...
void Them1CauHoi(DSCH &dsch, DanhSachID &dsID, CauHoi *a)
...
void RemoveCH(DSCH &dsch, int id);
...
int* LayDeThi(DSCH &dsch, int sct, const string &mamon) 
...
void ChuanHoaTen (string &text) //đã sửa
{
	if(text[0] == 32)
	{
		text.erase(0,1);
...
//đã xóa TaoMandRD(),Random() và RamdomMang() ở đây.
